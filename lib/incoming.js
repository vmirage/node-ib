...
Incoming.prototype._HISTORICAL_DATA = function () {
  ...
  if (this._continue) {
    version = this._continue._data.version;
    reqId = this._continue._data.reqId;
    startDateStr = this._continue._data.startDateStr;
    endDateStr = this._continue._data.version.endDateStr;
    completedIndicator = this._continue._data.completedIndicator;
    itemCount = this._continue._data.itemCount;
  } else {
    version = this.dequeueInt();
    reqId = this.dequeueInt();
  ...
  while (itemCount--) {
    ...
    if (itemCount > 0 && this._dataQueue.length < expectedLength) {
      this._continue = new Continue(this._token, {
        version: version,
        reqId: reqId,
...
Incoming.prototype._SCANNER_DATA = function () {
  ...
  if (this._continue) {
    version = this._continue._data.version;
    tickerId = this._continue._data.tickerId;
    numberOfElements = this._continue._data.numberOfElements;
  } else {
    version = this.dequeueInt();
  ...
  while (numberOfElements--) {
    ...
    if (numberOfElements > 0 && this._dataQueue.length < expectedLength) {
      this._continue = new Continue(this._token, {
        version: version,
        tickerId: tickerId,
...
Incoming.prototype.process = function () {
  ...
  if (this._continue) {
    this._token = this._continue._token;
    constKey = this._controller._ib.util.incomingToString(this._continue._token);
    this['_' + constKey]();
    return;
  }
